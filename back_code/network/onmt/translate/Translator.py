    ...
    def translate(self, src_dir, src_path, tgt_path,
        ...
        for batch in data_iter:
            ...
            for trans in translations:
                LIST_predict.append({'score': trans.pred_scores[0], 'area': trans.pred_sents[0]})
                # print trans.pred_sents[0]
                # print dir(trans)
                # print trans.log
                ...
                if self.verbose:
                    ...
                    os.write(1, ' '.join(trans.src_raw).encode('utf-8'))
        ...
        return all_scores, LIST_predict
